...
export const landingPage: LandingPage = {
  ...
  blocks: [
...

    {
      ...
      pillars: [
        ...
        },
        {
          ...
          body: 'Prices and fundamentals come from a licensed market data provider, refreshed on every run. No synthetic series, no stale caches.',
        },
        {
...

    {
      ...
      index: '06',
      label: 'Pricing',
      heading: 'Start with the whole engine.',
      tiers: [
        {
          name: 'Open',
          price: 'Free',
          summary: 'Everything the engine computes, on up to 3 tickers.',
          features: ['Full risk stack & Monte Carlo', 'Historical stress testing', 'CSV export'],
          action: { label: 'Launch the app', href: APP_URL, variant: 'secondary' },
        },
        {
          name: 'Analyst',
          price: '$19',
          period: '/mo',
          summary: 'For a portfolio you actually manage.',
          features: ['Up to 25 holdings', 'Saved portfolios & run history', '10,000-path simulations', 'Branded PDF reports'],
          action: { label: 'Start Analyst', href: APP_URL, variant: 'primary' },
          featured: true,
        },
        {
          name: 'Desk',
          price: '$79',
          period: '/mo',
          summary: 'For advisors reporting to clients.',
          features: ['Unlimited holdings & portfolios', 'Client-ready report templates', 'Custom stress scenarios', 'API access'],
          action: { label: 'Talk to us', href: '/contact', variant: 'secondary' },
        },
      ],
    },

    {
      ...
      items: [
        ...
        {
          question: 'Why is the free tier limited to a few tickers?',
          answer: 'Correlated simulation cost grows with the square of the position count, and market data is metered per symbol. Three holdings is enough to see every part of the engine work; larger books move to a paid tier.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Daily prices and company fundamentals are pulled live from a licensed market data API on each analysis run, over the window you select — up to the maximum available history.',
        },
      ],
    },
